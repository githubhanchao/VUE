...
<template>
  <el-card id="batch-agentpay-query-cond" class="batch-agentpay-query-cond">
    <el-form id="form" ref="formModel" :model="formModel" :rules="rules" onsubmit="return false;">
      <el-row :gutter="20">
        ...
        <!--<el-col :span="8">-->
          <!--<el-input size="large" id="uploadFileName" v-model="formModel.uploadFileName" placeholder="上传文件名"></el-input>-->
        <!--</el-col>-->
        <el-col :span="8">
      ...
      <el-row :gutter="20" type="flex" style="margin-bottom: 0">
        <el-col :span="4" class="col_btn_bg">
          <el-button size="large" class="batch_agentpay_query_btn" type="primary" style="width: 110px;"
...
<script>
  ...
  export default {
    name: 'batch-agentpay-query-cond',
    props: {
      action: {
        type: String,
        required: true,
    ...
    watch: {
      pageSizeProp (value) {
        ...
        this.pageSize = value;
        this.queryAgentpayUnverifyList();
      },
    ...
    methods: {
      ...
      queryAgentpayUnverifyList () {
        ...
        const condParams = {
          ...
          //          uploadFileName: this.formModel.uploadFileName,
          page: this.pageIndex,
...
<style scoped="batch-agentpay-query-cond">
...
.batch_agentpay_query_btn {
  width: 100%;
}
.batch-agentpay-query-cond .el-form {
  padding: 0 0;
}
.batch-agentpay-query-cond .el-form-item {
  margin: 0px 0px;
  padding: 0 0;
}
.batch-agentpay-query-cond .el-col {
  max-width: 340px;
}
</style>
