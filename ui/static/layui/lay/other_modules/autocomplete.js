layui.define(['jquery', 'laytpl', 'layer'], function (e) {
    "use strict";
    layui.link('static/layui/css/autocomplete.css');
    var hint = layui.hint(),
        $ = layui.jquery,
        laytpl = layui.laytpl,
        layer = layui.layer,
    ...
    job.prototype.pullData = function () {
        ...
        (!_config.cache && _config.ajax[_self.index] != undefined) && _config.ajax[_self.index].abort(), _config.ajax[_self.index] = $.ajax({
            ...
            success: function (resp) {
              return !resp.success ? layer.msg(resp.ret_msg) : _config.data[_self.index] = resp.ret_obj, _self.renderData(_config.data[_self.index])
